...
### CLL
- pneumokokken: bij diagnose
	- behandelindicatie? dan voorkeur vooraf 1e vaccinatie
- shingrix: voor start behandeling
- influenza: jaarlijks
#### MBL
- niet vaccineren
### HCL
...
- eerst prevenar, 2 maanden later pneumovax:
	...
	- pneumovax-23: T-cel onafhankelijke respons → a 5jaar herhalen (wel vs. meer serotypes)
		...
		- E12,70 bijbetaling
### Shingrix
- incidentie VZV bij hematologische maligniteiten 10x hoger
- indicaties:
...
- vaak verminderde vaccinatierespons door ziekte én behandeling
	...
	- bij primovaccinatie effect meest uitgesproken
#### Voorafgaand aan therapie
- pneumokokkenvaccin bij MGUS, MM en CLL
	- liefst minimaal 2 weken vóór start chemo/immuno
			- geldt ook voor **shingrix**? zie [[Vaccinaties#Tijdens onderhoudsbehandeling#CLL]]
#### Tijdens therapie
- meestal minder effectief
#### Na therapie
##### Na chemo
- minimaal 3m na afronden
	- m.u.v. influenzavaccinatie: onvoldoende onderbouwing
##### Direct voor SCT
- meestal beperkt effectief
	- overweeg pneumokokkeninfecties bij MM vanwege verhoogde risico
##### Direct na SCT
- niet zinvol i.v.m. nog plaats te vinden immuunreconstitutie
	- dus enkele maanden nadien
		- m.u.v. influenza- en pneumokokkeninfecties: hoog risico, eerder aangevangen
##### Tijdens onderhoudsbehandeling
###### Lymfoom
- wacht minimaal 8m na staken anti-CD20 behandeling
###### MM
- onderhoud met lenalidomide beïnvloedt vaccinatierespons niet negatief
###### CLL
- wacht minimaal 8m na staken anti-CD20 behandeling
- ibrutinib vermindert vaccinatierespons op:
	- influenzavaccin
	- PCV13 (in sterke mate), dus **vóór start**
	- Shingrix (in sterke mate), dus **vóór start**
##### Tijdens IgG-suppletietherapie (IVIG, sIgG, fsIgG)
- kans op adequate antistofrespons laag
	- mogelijk wel kans op cellulaire vaccinatierespons
### Geïnactiveerde vaccins
- vb'en: gele koorts, rotavirus, BMR
- alléén als geen immuunsuppresie, dan minimaal 4w vóór start immuunsuppressieve behandeling. Bedenk:
	- biologische criteria (zoals CD4-getal) niet prospectief geevalueerd
	- gelijktijdige toediening twee levend verzwakte vaccins gecontra-indiceerd
	- therapie-specifieke overwegingen
		- tijdens immuunglobuline suppletie: worden vaak weggevangen, uitzonderingen: gelekoortsvaccin en rotavirusvaccin (weinig AS'en aanwezig)
			- anders circa 8m na staken
		- aCD20: minimaal 13m nadien
		- aCD38 (daratumumab): levend verzwakt eigenlijk altijd gecontraindiceerd
...
- na allo 60% nog adequate titers, óók cases bekend van b.v. CLL-behandeling met FCR die overleed door mazelen
	- bij verheffing in NL of reizen naar land met uitbraken hervaccinatie met 1x BMR-vaccin (eventueel 2e i.f.v. titercontrole)
- postexpositieprofylaxe: zie [mazelen richtlijn](https://lci.rivm.nl/richtlijnen/mazelen)
### Pneumokokkenvaccinatie
- hoogste incidentie MM, NHL en CLL
	- leeftijd risicofactor
- PPV23 stimuleert B-cellen zonder T-celhulp: geen immunologisch geheugen
- Geconjugeerde vaccins wél (PCV10, PCV13, PCV15, PCV20, PCV21, PCV24)
#### Herhaalde doses PPV23
- in ieder geval eenmalig 5j na eerste PPV23-dosis
#### PCV20
- in '22 geregistreerd, even effectief als PCV13+PPV23 en qua immunogeniciteit goed alternatief
	- iets minder serotypen
- nog niet opgenomen in internationale richtlijnen
#### Serologische bepalingen na vaccinatie
- niet zinvol in praktijk
### DKTP
#### Tetanus
- immuungecompromiteerd en wond met tetanusrisico: booster met daarnaast ook tetanusimmuunglobuline (ook als <10j geleden nog vaccin)
- D(K)TP-boosters bij reizen naar specifieke reisbestemmingen
- na SCT volledige D(K)TP-vaccinaties
- na ALL/AML-behandeling kan immuniteit zijn afgenomen: reizigers booster
#### Kinkhoest
- Bordetella pertussis, m.n. ernstige complicaties neonaten (w22 maternale kinkhoestvaccinatie), kind vervolgens 3-5-11 maandenschema
	- enkel immuungecompromitteerde zwangeren geen 22-wekenprik en kind vervolgens 2-3-5-11 maandenschema
### Varicellavaccin (Provarivax)
- t.v.v. primaire VZV-infectie (waterpokken)
- niet in RVP en slechts beperkt daarbuiten, o.a.:
	- kinderen negatieve VZV-IgG na behandeling
	- VZV-IgG negatieve vrouwen met zwangerschapswens
- Shingrix niet geindiceerd t.p.v. waterpokken (primo infectie)
## Post-expositiebeleid
- zie respectievelijke richtlijnen in geval van blootstelling bij immuungecompromitteerden:
	- hepatitis A, hepatitis B, mazelen, meningokokken, rabiës, tetanus, waterpokken (en seronegativiteit)
## Vaccinatie van huisgenoten
### Influenzavaccin
- jaarlijks vaccineren in huishoudens patiënten met hematologische aandoeningen, immuundeficiënties of behandeling ervan
### Levend verzwakte vaccins
- geen transmissie behálve:
	- rotavirusvaccin bij zuigelingen
		- minstens 2-4w na eerste rotavirusvaccinatie bij zuigelingen contact met ontlasting vermijden
	- varicella ook beschreven in aanwezigheid van rash (na varicalla- of zostavax)
		- vermijd contact zolang 'rash'
### Varicellavaccin
- overweeg vaccineren seronegatieve huisgenoten
	- (standaardadvies is uiterlijk tot 10 dagen na blootstelling humaan VZIG of antivirale therapie)
## Vaccinatie gezondheidspersoneel
### Influenzavaccin
- jaarlijks bij dagelijks contact tegen influenza
### Mazelenvaccin
- titercontrole indien geboren tussen 1965 - 1978
	- negatieve titer? vaccineren met BMR-vaccin
		- indien rash, tijdelijk geen contact met patiënten 
### Varicellavaccin
- levend verzwakt indien seronegatief
## MGUS en MM
### MGUS
#### Infectierisico
- Zweeds bevolkingsonderzoek, verhoogd tijdens 10-jarige FU:
	- HR 2.0 pneumonie
	- HR 2.7 influenza
	- HR 2.8 zoster
#### Influenzavaccinatie
- geadviseerd, ook < 60j
	- effect niet onderzocht
#### Pneumokokkenvaccinatie
- vanaf 60j PCV13+PPV23 
	- effect incidentie CAP niet onderzocht
	- antistofproductie minder dan gezonde controles, wel béter dan MM
#### Overig geïnactiveerd
- niet onderzocht, vermoedelijk mindere titerrespons
	- advies: meten vaccinatierespons na hep A/B, indien geindiceerd
- Shingrix nog niet onderzocht bij MGUS, nog geen indicatie (wellicht later aanbevolen >50j)
#### Levend verzwakt
- Zostavax niet onderzocht, mogelijk risico vaccinvirusinfectie
	- afgenomen immuniteit bij MGUS (CD4+ en CD8+ cellen): consulteer expert
### MM
#### Infectierisico
- m.n. eerste 3-12m verhoogd risico S. pneumoniae en H. influenzae
	- oorzaak van 20% van overlijdens bij MM-patiënten
		- HR 18.0 invasieve pneumokokkenziekte < 65j
		- HR 5.0 invasieve pneumokokkenziekte < 65j
- vaker virale LWI's, o.a. influenza (HR 6.0)
- ook vaker VZV-reactivaties door behandelingen met aCD38 of proteasoom-inhibitoren
#### Influenzavaccinatie
- jaarlijks influenza (eenmalig), ook al <60j
	- bewijs voor effect in Cochrane meta-analyse
	- bewijs voor effectiviteit twee vaccinaties aanwezig maar niet overtuigend
	- aCD38 vermindert influenzavaccinatierespons slechts beperkt
#### Pneumokokkenvaccinatie
- z.s.m. na diagnose PCV13 + PPV23, ook <60j
	- **bij voorkeur minimaal 2w vóór start chemotherapie**
		- (**óf pas tijdens onderhoudsbehandeling**)
	- zowel vóór als ná autoloog
- vooral serologisch bewijs
- respons op vaccinatie verminderd, ook bij smouldering MM
	- aCD38 vermindert respons slechts beperkt
	- lenalidomide vermindert respons niet
#### Overig geïnactiveerd
- Afgenomen vaccinatierespons aannemelijk
##### Tetanus
- booster en tetanusimmuunglobulines bij verwonding met tetanusrisico
##### Herpes zoster
- Shingrix (recombinant zostervaccin)
	- substantiële bescherming in **eerste 12m** na vaccinatie
		- optimale resultaat **ná chemotherapie** (lagere titers ná chemotherapie)
	- advies: "proactief gebruik", vooral bij proteasoom-inhibitoren en aCD38
##### Hib
- conflicterende gegevens over antistoftiters bij MM
	- noodzaak onduidelijk
#### Levend verzwakt bij MM
- gecontra-indiceerd tot 2j na auto-SCT
## CLL
#### Infectierisico
- m.n. humorale immuundeficiëntie, maar ook verminderde cellulaire immuniteit
	- HR 18.0 invasieve pneumokokkenziekte
	- HZV frequente complicatie, shingrix mogelijk effectief
- verminderde serologische respons
- bij voorkeur vroeg ('watchful waiting') of ten minste 8 maanden ná beëindiging chemo-immunotherapie vanwege negatieve effect B-celdepleterende therapie
- BELANGRIJK: vaccineren vóór start ibrutinib
	- voor boostervaccinaties wellicht minder belangrijk
#### Influenzavaccinatie
- jaarlijks, ook <60 jaar
	- vaccinrespons matig tot ernstig afgenomen
	- bij ibrutinib NIET zinvol
		- vaccinatie huisgenoten wel zinvol
#### Pneumokokkenvaccinatie
- PPV23
	- waarschijnlijk weinig effectief
- PCV13
	- bij ernstige hypogammaglobulinemie en tijdens chemo niet zinvol
	- vóór start behandeling haalt 60% beschermende titers
- advies desondanks PCV13 + PPV23
	- indien PPV23 al toegediend, dan PCV13 minstens 12 maanden nadien alsnog
	- vaccinatie alleen zinvol vóór start ibrutinib
#### Overig geïnactiveerd
- bij verwondingen met risico altijd TIG náást boostervaccinatie
	- tetanus verminderde vaccinatierespons
- na Shingrix nauwelijks humorale immuniteit, cellulair ok
	- effectiviteit niet bekend, wordt wél vergoed
#### Levend verzwakt
- gecontra-indiceerd i.v.m. veiligheidsrisico!
## Na stamceltransplantatie
### Autologe SCT
- advies conform Duitse en EUropese richtlijnen: vaccineren zoals na allo-SCT
	- over Shingrix geen adviezen gegeven omdat destijds nog geen evidence
#### Verlies preexistente immuniteit
- mazelen: circa 40% nog maar beschermende antistoftiters
- geïnactiveerde vaccins:
	- 30-50% verloor antistoftiters tegen tetanus
	- lagere antistoftiters tegen tetanus, pneumokokken, polio, hepatitis B en difterie
		- pas na meerdere boosters herstel
...
- onder TKI's vaker HZV en HBV-reactivaties
	- Shingrix kan indien artensverklaring
- onder TKI's en JAK-remmers levend verzwakte vaccins gecontraindiceerd
### Lymfoom
- indien indolent en vóór start behandeling:
	- PCV13 + PPV23 (HR 10.0 bij IPD)
	- Shingrix
	- jaarlijks influenza
- 8m na staken aCD20-therapie: 
	- influenza
	- PCV13 + PPV23
- na chemotherapeutische behandeling:
	- tot 25% verliest immuniteit tegen difterie en tetanus:
		- D(K)TP-booster
	- jaarlijks influenza tot niet meer immuungecompromitteerd 
### Myeloproliferatieve neoplasmata
- indien PMF en PV en ruxolitinib:
	- shingrix vanwege verhoogd risico VZV
### MDS
- gezien bijna altijd >60j: 
	- jaarlijks influenza en PPV23 (**jaarlijks??**)
		- vaccinatierepons lijkt onveranderd, ook niet na HMA
- HZV komt vaker voor bij MDS maar geen evidence voor Shingrix, wél (soort van) aanbevolen
### Overige hematologische aandoeningen
#### Functionele asplenie
- sikkelcelziekte en andere hemoglobinopathieën, hemofilie, ET, PV en complementdeficiënties
- verhoogd risico op 
	- pneumokokken, HiB en meningokokken
	- infecties na dierenbeten door hond of kat
	- malaria
	- babesiosis (tekenbeet in VS)
- advies:
	- PCV13 + PPV23, laatstgenoemde 5-jaarlijks
		- liefst volledig voor ingreep
		- indien PPV23 al gegeven, minimaal 12m tussen PCV13 en PPV23
	- jaarlijks influenza
	- MenACWY en MenB (1+1)
	- Hib (eventueel 2e hervaccinatie)

![[Pasted image 20240320154423.png]]
## Medicatie gebruikt bij hematologische aandoeningen
zie [tabel 6.2](https://lci.rivm.nl/richtlijnen/vaccinatie-bij-chronisch-inflammatoire-aandoeningen#6-2-vaccins-naar-type-vaccin-en-immuunrespons-bij-immuuncompetente-personen) 
## Anki
nee
## Aliassen
## Datum laatste update
18-03-2024
___
# COVID-19 vaccinatie van immuungecompromitteerde patiënten; LCI-richtlijn januari '24
## Samenvatting
...
### Dosering
- in principe één dosis
	- tenzij afwezigheid bestaande immuniteit, dan één dosis onvoldoende: **hervaccinatie**
- alle vaccins veilig
### Hervaccinatie
...
## Inleiding
- maart '21: iedere immuungecompromitteerde patiënt gevaccineerd. Twee studies:
	- COBRA-KAI: 17 vooraf gedefinieerde cohorten
	- CoVvhaem: retrospectief, 160 patiënten met B-celmaligniteiten
## mRNA vaccins
- SARS-CoV-2-specifiek mRNA in oplosbare nanopartikels; codeert voor spike eiwit -> spike-eiwitten door spiercellen rondom injectieplaats -> antigeenpresenterende cellen in regionale lymfeklieren: T- en B-celrespons
...
- moeilijk te interpreteren: o.a. toename bindingsterkte en functionaliteit bij afname titers, bovendien cellulaire immuniteit van belang
