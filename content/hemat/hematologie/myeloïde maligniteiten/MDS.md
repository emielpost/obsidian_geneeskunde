...
- dysplasie $\geq$ 10% in merg of PB in $\geq$ cellijn:
	...
	- beenmerg (> 500 beoordelen): 
		...
		- granulocytopoiese
			- links verschuiving, toename blasten, Auerse staven of Auerse lichaampjes, hypo-/degranulatie, pseudo-Pelger cellen, kernafwijkingen (hypersegmentatie, abnormale chromatine klontering), MPO deficientie, monocytose en morfologische afwijkingen monocyten
### Histopathologie
...
- spliceosome
	- o.a. SF3B1, SF1
behalve EZH2 nog niet van therapeutisch of prognotisch belang. Wel steeds belangrijker.
## Classificatie
### FAB-classificatie
oud: o.b.v. blasten in BM en PB, % ringsidero's in BM en aantal mono's in PB
### WHO 2008 classificatie
nieuw: MDS met dysplasie in 1 cellijn = MDS met unilineage dysplasie (RCUD)
- RCUD-RA
- RCUD-RN
- RCUD-RT
nieuw: 
...
- MDS vs. MPN
	- cytopenie vs. overproductie
	- atypie megakaryo's
	- pas op fibrose soms bij MDS
## Myelodysplastisch neoplasma volgens WHO 2022
### MDS met definiërende genetische afwijkingen
#### MDS met laag blastenaantal en SF3B1 mutatie (MDS-SF3B1)
...
- één additionele afwijking mag, m.u.v.:
	- -7, del(5q), AML-defining mutaties of bi-allelisch verlies TP53
	- klein deel met SF3B1 of JAK2V617F (nog steeds MDS-5q)
- vaak trombocytose en typisch mono- of bilobaire megakaryo's
#### MDS met bi-allelische TP53 inactivatie (MDS-biTP53)
- vaak MDS met blastentoename en fibrose
	- slechte prognose, onafhankelijk van IPSS-R
- na chemo/radiatie? 
	- myeloide neoplasma post cytotoxische therapie (eMN-pCT)
### MDS gedefinieerd door morfologie
#### MDS met laag aantal blasten (MDS-LB)
...
- DD 
	...
	- PNH
	- HCL
#### MDS met toegenomen blasten (MDS-IB)
- monocyten < 0.5
###### MDS-IB1
- blasten 5-9% beenmerg,  2-4% PB
	- geen Auerse staven
###### MDS-IB2
- blasten 10-19% beenmerg, of 5-19% PB
	- geen Auerse staven
- blastair beenmerg
- fibrose < MF2
###### MDS met toename blasten en fibrose (MDS-f)
