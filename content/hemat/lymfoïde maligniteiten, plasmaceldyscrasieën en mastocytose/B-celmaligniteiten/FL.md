...
- 6x R-CHOP (of R-DHAP/R-VIM/R-DHAP) + consolidatie met autoloog
	- c.i. of mobilisatiefalen? overweeg consolidatie met radio-immunotherapie
- refractair op inductie met R-CHOP of R-DHAP:
	- autoloog enige optie, wel eerst salvage therapie 
	- overweeg ook zeker CD19 CAR-T in studieverband b.v.
		- Yescarta nog in sluis
#### rol van allogeen in behandeling tFL
- niet in eerste lijn
- overweeg als recidief tFL na eerder autoloog
## Aanvullende maatregelen
### Hepatitis C
- bij aanwijzingen infectie: verwijzen naar MDL-arts
### Hepatitis B
- actieve HBV: start antivirale therapie tot minimaal 18 maanden na staken chemo/immunotherapie (i.o.m. MDL)
- doorgemaakte HBV:
	- anti-HBs en anti-HBc positief
		- HBV aantoonbaar: start antivirale therapie
		- HBV niet aantoonbaar: anti-HBs vervolgen
	- "core positives" (enkel anti-HBc positief)
		- HBV, HBsAg en transaminasen vervolgen (a 3 weken) tot 18 maanden na laatste gift chemo/immunotherapie
			- zodra aantoonbaar: start tenofovir of entecavir (i.o.m. MDL)
...
## Perifeer bloed
- morfologie
	- leuko's meestal licht verhoogd; vaak kleine lymfo's met gekliefde kern (eveneens "buttock" cells)
		- zelden blastair
	- beenmergaspiraat nog weleens negatief
- IFT
