...
- dara-Vd (2e keuze)
	- mits niet bortezomib/carfilzomib refractair
- dara-pom-dex (niet de voorkeur)
###### dara voorbehandeld of refractair
- **pom-Vd of Kd (1e keuze)**
- Vd (inferieur)
### Behandeling 3e lijn
![[Pasted image 20240228144927.png]]
#### meestal bortezomib en lenalidomide refractair
- algemeen
	- mediane OS 9 maanden, EFS 5 maanden
		- let op frailty/comorbiditeit
	- **studieverband**!
###### niet voorbehandeld met/refractair onder daratumumab
...
- voor start, gebitssanering
	- indien tijdens:
		- clinda- of augmentin vs. o.a. actinomyces
		- stop 3m voor en 3m na
- calcium/vitamine D, tenzij hypercalciëmie
- radiotherapie
	- solitair plasmacytoom
	- symptomatische myelumcompressie
	- persisterende pijn lytische laesie
	- preventie pathologische fractuur en dreigende fractuur (zie SIN score op p75)
- kyfoplastiek (zelden; wordt nu niet vergoed)
	- overweeg bij pijnlijke compressiefracturen
- orthopedische chirurgie
	- fixatie pathologische fractuur pijpbeenderen
	- stabilisatie instabiele axiale fractuur
	- compressie t.g.v. botfragmenten
	- dreigende pathologische fractuur
#### tromboseprofylaxe
- schat bij alle nieuwe MM-patiënten VTE risico in m.b.v. IMPEDE-VTE score (zie p79)
	- iedereen LMWH (2850IE)
	- tenzij IMPEDE <4: carbasalaatcalcium 100mg
...
##### vaccinaties
- influenza iedere patiënt en huisgenoten
- pneumococcen bij iedere patiënt, ook SMM
	- geen HDM en autoloog:
		- prevenar + pneumovax na 60-90 dagen (a 5j)
	- HDM en autoloog:
		- prevenar voorafgaand aan SCT
		- prevenar + pneumovax volgens revaccinatieschema ná SCT (a 5j)
- shinrix bij ieder MM
	- vermijd levend geattenueerd, b.v. zostavax
- COVID-19 volgens LCI richtlijn
###### na HDM en autologe SCT
![[Pasted image 20240228153142.png]]
##### IVIG
- meer dan 2 infecties/jaar of ernstig en hypogammaglobulinemie, en IgG en IgA lager dan normaal
	- streef IgG 5-7 gram
#### EPO
- Hb < 6.2 ondanks behandeling
	- max Hb 7.4
	- stop indien na 4w geen effect
	- opties:
		- aranesp 150 mcg/w of 500 mcg /3w
		- eprex 40.000U/w
		- neorecormon 30.000U/w
